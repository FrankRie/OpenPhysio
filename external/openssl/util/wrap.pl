...
BEGIN {
    ...
    require '/d/Frank/Dokumente/Projekte/openphysio/branch6/external/openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/d/Frank/Dokumente/Projekte/openphysio/branch6/external/openssl/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = '/d/Frank/Dokumente/Projekte/openphysio/branch6/external/openssl/test/default-and-jitter.cnf';
    shift;
