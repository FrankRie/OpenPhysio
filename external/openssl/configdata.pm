...
our %config = (
    ...
    "openssldir" => "/d/Frank/Dokumente/Projekte/openphysio/branch6/external/openssl/../install",
    "options" => "--prefix=/d/Frank/Dokumente/Projekte/openphysio/branch6/external/openssl/../install --openssldir=/d/Frank/Dokumente/Projekte/openphysio/branch6/external/openssl/../install no-acvp-tests no-afalgeng no-asan no-brotli no-brotli-dynamic no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-demos no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-jitter no-fips-post no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-h3demo no-hqinterop no-jitter no-ktls no-loadereng no-md2 no-msan no-pie no-rc5 no-sctp no-shared no-ssl3 no-ssl3-method no-sslkeylog no-tests no-tfo no-trace no-ubsan no-unit-test no-uplink no-weak-ssl-ciphers no-zlib no-zlib-dynamic no-zstd no-zstd-dynamic",
    "patch" => "4",
    "perl_archname" => "x86_64-cygwin-thread-multi",
    "perl_cmd" => "perl",
    "perl_version" => "5.40.3",
    "perlargv" => [
        "mingw64",
        "no-shared",
        "no-tests",
        "--prefix=/d/Frank/Dokumente/Projekte/openphysio/branch6/external/openssl/../install",
        "--openssldir=/d/Frank/Dokumente/Projekte/openphysio/branch6/external/openssl/../install"
    ],
    "perlenv" => {
        "AR" => undef,
...
unless (caller) {
    ...
    use lib '/d/Frank/Dokumente/Projekte/openphysio/branch6/external/openssl/util/perl';
    use OpenSSL::fallback '/d/Frank/Dokumente/Projekte/openphysio/branch6/external/openssl/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/d/Frank/Dokumente/Projekte/openphysio/branch6/external/openssl/Configurations';
        use gentemplate;
